...
public class SettingsActivity extends AppCompatActivity {
    ...
    Toolbar toolbar;
    Button submitBtn;
    EditText rr,fr,ff,fl,ll,bl,bb,br,resetMotor,fi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fi = findViewById(R.id.fire);
        fi.setText(String.valueOf(sharedPreferenceManager.getfire()));
