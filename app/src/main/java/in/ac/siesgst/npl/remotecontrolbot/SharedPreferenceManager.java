...
public class SharedPreferenceManager {
    ...
    Context context;
    public static final String PREF_NAME = "AUTONXT_AUTOMATIONS ";
    ...
    public void changeAllControls(int rr,int fr,int ff, int fl, int ll, int bl, int bb, int br, int resetmotor,int fi) {
        editor.putInt("rr",rr);
        editor.putInt("fr",fr);
        editor.putInt("ff",ff);
        editor.putInt("fl",fl);
    ...
    int getfire() {
        return sharedPreferences.getInt("fire",0);
    }
